(function(){
    ...
    {
        return
        ".cocosLoading{position:absolute;margin:-30px -60px;padding:0;top:50%;left:50%}"
        ...
        +".cocosLoading li .ball,.cocosLoading li .unball{background-color:#2187e7;"
        ...
        +"-moz-animation:showDot 1s linear forwards;-webkit-animation:showDot 1s linear forwards}"
        ...
        +"-moz-animation:hideDot 1s linear forwards;-webkit-animation:hideDot 1s linear forwards}"
    ...
    var startAnimation=function(list,callback){
        ...
        var animation=function(){
            setTimeout(function(){
                ...
                var item=list[index];
                if(direction){item.ball.className="ball"
            }
            else
            {
